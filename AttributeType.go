...
var attributeTypeMap = [256]attributeTypeDesc{
	...
	ServiceType:            {"ServiceType", avpUint32},
	...
	AcctStatusType:         {"AcctStatusType", avpUint32Enum{1: "Start", "Stop", "InterimUpdate", 7: "Accounting-On", 8: "Accounting-Off"}},
	...
	AcctTerminateCause:     {"AcctTerminateCause", avpUint32},
	AcctMultiSessionId:     {"AcctMultiSessionId", avpString},
	AcctLinkCount:          {"AcctLinkCount", avpUint32},
	AcctInputGigawords:     {"AcctInputGigawords", avpBinary},
	AcctOutputGigawords:    {"AcctOutputGigawords", avpBinary},
	...
	NASPortType:            {"NASPortType", avpUint32},
	...
	EAPMessage:                   {"EAPMessage", avpString},
